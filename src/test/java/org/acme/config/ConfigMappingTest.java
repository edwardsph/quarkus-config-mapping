...
//    Proxies proxies;
    ...
    void yamlConfigMapping() throws Exception {
        final SmallRyeConfig config = new SmallRyeConfigBuilder()
                ...
                .withSources(new YamlConfigSource(ConfigMappingTest.class.getResource("/application.yml")))
                .build();
        final Proxies proxies = config.getConfigMapping(Proxies.class);
    ...
    interface ConnectionConfig {
        ...
        interface EncryptionConfig {
            ...
            @WithName("truststore")
            Optional<KeystoreConfig> truststore();
        }
